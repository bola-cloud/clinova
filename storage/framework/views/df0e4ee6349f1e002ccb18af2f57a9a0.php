...
<div class="space-y-6" dir="<?php echo e(app()->getLocale() === 'ar' ? 'rtl' : 'ltr'); ?>">
    ...
    <div <?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processElementKey('booking-modal-container', get_defined_vars()); ?>wire:key="booking-modal-container" class="fixed inset-0 z-[60] flex items-center justify-center p-4">
