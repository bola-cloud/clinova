...
<div class="grid grid-cols-1 lg:grid-cols-3 gap-8" dir="<?php echo e(app()->getLocale() === 'ar' ? 'rtl' : 'ltr'); ?>">
    <?php if (! $__env->hasRenderedOnce('4aabe7ef-4fd7-4e84-a86b-2b76a7a8d8e7')): $__env->markAsRenderedOnce('4aabe7ef-4fd7-4e84-a86b-2b76a7a8d8e7');
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                ...
                <div class="md:col-span-2">
                    <button type="submit" class="w-full py-3 bg-purple-600 text-white rounded-xl font-bold mt-2 shadow-lg shadow-purple-200"><?php echo e(__('Save Patient')); ?></button>
                </div>
            </form>
            ...
            <div class="relative group">
                ...
                <input wire:model.live="search" type="text" placeholder="<?php echo e(__('Search by patient name or phone to book...')); ?>" 
                       class="w-full <?php echo e(app()->getLocale() === 'ar' ? 'pr-11 pl-12' : 'pl-11 pr-12'); ?> py-4 bg-gray-50 border-none rounded-2xl focus:ring-2 focus:ring-purple-500 transition-all shadow-inner text-lg">
                ...
                <div class="absolute w-full mt-3 bg-white border border-gray-100 rounded-3xl shadow-2xl z-20 overflow-hidden divide-y divide-gray-50 animate-fade-in-down">
                    ...
                    <div class="p-0 transition-all">
                        <div class="p-4 hover:bg-gray-50 flex items-center justify-between cursor-pointer" wire:click="selectForBooking(<?php echo e($patient->id); ?>)">
                            ...
                            <div class="flex items-center gap-3">
                                <span class="text-sm font-medium text-purple-600 group-hover:underline"><?php echo e(__('Record Appointment')); ?></span>
                        ...
                        <div class="bg-purple-50/50 p-5 border-t border-purple-100 animate-slide-in-top">
                            <div class="flex items-center gap-3 mb-4 text-purple-900">
                                ...
                                <span class="font-bold"><?php echo e(__('Book with Dr.')); ?> <?php echo e($assignedDoctorName); ?></span>
                            </div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                                ...
                                <div class="space-y-1">
                                    ...
                                    <select wire:model="bookingType" class="w-full px-3 py-2 bg-white border border-purple-200 rounded-xl focus:ring-2 focus:ring-purple-500 shadow-sm text-sm">
                                        <option value="consultation"><?php echo e(__('Consultation Case')); ?></option>
                                        <option value="followup"><?php echo e(__('Follow-up Case')); ?></option>
                                    </select>
                                </div>
        ...
        <div class="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden text-right">
            <div class="p-6 border-b border-gray-100 flex flex-col md:flex-row items-center justify-between gap-4">
                <h3 class="font-bold text-lg flex items-center gap-2">
                    ...
                    <?php echo e(__('Daily Schedule')); ?>

                </h3>
                
                <div class="flex items-center gap-3 bg-gray-50 p-2 rounded-xl border border-gray-200">
                    <button wire:click="setDate('<?php echo e(\Carbon\Carbon::parse($selectedDate)->subDay()->format('Y-m-d')); ?>')" class="p-2 hover:bg-white rounded-lg transition-colors text-gray-500 hover:text-purple-600 shadow-sm">
                    ...
                    <button wire:click="setDate('<?php echo e(\Carbon\Carbon::parse($selectedDate)->addDay()->format('Y-m-d')); ?>')" class="p-2 hover:bg-white rounded-lg transition-colors text-gray-500 hover:text-purple-600 shadow-sm">
    ...
    <div class="space-y-8">
        ...
        <div class="bg-gradient-to-br from-purple-600 to-indigo-700 text-white p-8 rounded-[2rem] shadow-xl shadow-purple-200">
            ...
            <div class="text-5xl font-bold mb-6 tabular-nums"><?php echo e($dayCount); ?></div>
            <div class="space-y-3">
                <div class="flex items-center justify-between text-sm bg-white/10 p-3 rounded-xl border border-white/10">
                    ...
                    <span class="font-bold"><?php echo e($pendingCount); ?></span>
                </div>
                <div class="flex items-center justify-between text-sm bg-white/10 p-3 rounded-xl border border-white/10">
                    <span><?php echo e(__('Prepared Cases')); ?></span>
                    <span class="font-bold"><?php echo e($preparedCount); ?></span>
                </div>
            </div>
        </div>
    </div>
