...
<?php $component = App\View\Components\ClinicLayout::resolve(['title' => 'لوحة الطبيب'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
[$__name, $__params] = $__split('dashboard.doctor-dashboard', []);

$__key = null;

$__key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-1493642976-0', $__key);
...
<?php endif; ?>
<?php /**PATH C:\Bola\Clinova\resources\views/dashboard/doctor.blade.php ENDPATH**/ ?>