...
<?php $component = App\View\Components\ClinicLayout::resolve(['title' => ''.e(__('Control Panel')).''] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
[$__name, $__params] = $__split('dashboard.admin-settings', []);

$__key = null;

$__key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-3464265570-0', $__key);
...
<?php endif; ?>
<?php /**PATH C:\Bola\Clinova\resources\views/dashboard/admin-settings.blade.php ENDPATH**/ ?>