...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    ...
                    <tr <?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processElementKey('patient-{{ $patient->id }}', get_defined_vars()); ?>wire:key="patient-<?php echo e($patient->id); ?>" class="hover:bg-purple-50/30 transition-colors group">
                        ...
                        <td class="px-6 py-5 text-center">
                            ...
                            <div class="inline-flex items-center justify-center px-3 py-1 bg-rose-50 text-rose-700 rounded-lg text-xs font-bold border border-rose-100 gap-1">
                                ...
                                <?php echo e($totalFiles); ?> <?php echo e(__('Files')); ?>
    ...
    <div class="fixed inset-0 z-50 flex justify-center items-start overflow-y-auto p-4 md:p-10 bg-black/50 backdrop-blur-sm shadow-2xl transition-opacity animate-fade-in-down" dir="<?php echo e(app()->getLocale() === 'ar' ? 'rtl' : 'ltr'); ?>">
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
    ...
    <div <?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processElementKey('upload-modal-container', get_defined_vars()); ?>wire:key="upload-modal-container" class="fixed inset-0 z-[60] flex justify-center items-start overflow-y-auto p-4 md:p-10">
