...
<div class="space-y-6" dir="<?php echo e(app()->getLocale() === 'ar' ? 'rtl' : 'ltr'); ?>">
    ...
    <div class="bg-white p-6 rounded-3xl border border-gray-100 shadow-sm animate-fade-in-down">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
            <div>
                <label class="block text-xs font-bold text-gray-500 mb-2 uppercase tracking-wider"><?php echo e(__('Registration Date From')); ?></label>
            ...
            <div>
                <label class="block text-xs font-bold text-gray-500 mb-2 uppercase tracking-wider"><?php echo e(__('Registration Date To')); ?></label>
            ...
            <div>
                <label class="block text-xs font-bold text-gray-500 mb-2 uppercase tracking-wider"><?php echo e(__('Minimum Visits')); ?></label>
