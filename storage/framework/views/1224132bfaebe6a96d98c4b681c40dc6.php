                    ...
                    <div class="flex items-center justify-end gap-6 w-1/4">
                        <div class="flex items-center gap-3 px-4 py-2 bg-emerald-50 rounded-xl border border-emerald-100/50">
                            ...
                            <div class="flex flex-col text-right">
                                <span class="text-emerald-700 text-[9px] font-bold uppercase tracking-wider leading-none mb-0.5 opacity-70"><?php echo e(__('System Status')); ?></span>
                                <span class="text-emerald-800 text-xs font-black uppercase tracking-widest leading-none"><?php echo e(__('Online')); ?></span>
                            </div>
                        </div>
                    </div>
                </div>
