...
<div wire:poll.30s="checkReminders">
    ...
    <div x-data="{ 
         ...
         @reminder-alarm.window="add('<?php echo e(__('Reminder Alert!')); ?>', $event.detail.title + ': ' + $event.detail.content, 'alarm')"
...
</div><?php /**PATH C:\Bola\Clinova\resources\views\livewire/shared/doctor-reminders.blade.php ENDPATH**/ ?>