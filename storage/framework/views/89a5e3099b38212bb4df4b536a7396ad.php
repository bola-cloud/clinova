    ...
    <div class="bg-white rounded-3xl shadow-sm border border-gray-100 overflow-hidden">
        ...
        <form wire:submit.prevent="updatePassword" class="p-6 md:p-8 space-y-6">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div class="space-y-1.5">
                    <label class="text-sm font-bold text-gray-700"><?php echo e(__('Current Password')); ?></label>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                ...
                <div class="space-y-1.5">
                    <label class="text-sm font-bold text-gray-700"><?php echo e(__('New Password')); ?></label>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                ...
                <div class="space-y-1.5">
                    <label class="text-sm font-bold text-gray-700"><?php echo e(__('Confirm Password')); ?></label>
