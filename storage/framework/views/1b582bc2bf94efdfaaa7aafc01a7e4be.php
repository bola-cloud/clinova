...
<?php $component = App\View\Components\ClinicLayout::resolve(['title' => ''.e(__('Specialties Management')).''] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
[$__name, $__params] = $__split('dashboard.specialty-manager', []);

$__key = null;

$__key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-1789792943-0', $__key);
...
<?php endif; ?>
<?php /**PATH C:\Bola\Clinova\resources\views/dashboard/admin-specialties.blade.php ENDPATH**/ ?>