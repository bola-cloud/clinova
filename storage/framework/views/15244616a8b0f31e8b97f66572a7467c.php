                        ...
                        <td class="px-6 py-5 text-center">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($doctor->subscription_active): ?>
                                <div class="inline-flex flex-col items-center">
                                    ...
                                    <span class="text-[9px] text-gray-400 mt-1 font-bold"><?php echo e($doctor->subscription_expires_at?->format('Y-m-d')); ?></span>
                                </div>
                            <?php else: ?>
        ...
        <div class="bg-white rounded-[2.5rem] w-full max-w-md shadow-2xl overflow-hidden border border-white animate-zoom-in">
            <div class="p-10">
                ...
                <form wire:submit="saveQuotas" class="space-y-6">
                    <div class="space-y-2">
                        <label class="text-[10px] font-black text-gray-500 uppercase tracking-widest pl-1"><?php echo e(__('Maximum Patients')); ?> (0 = <?php echo e(__('Unlimited')); ?>)</label>
                        <div class="relative">
                            ...
                            <span class="absolute right-5 top-1/2 -translate-y-1/2 text-gray-400 text-xs font-bold"><?php echo e(__('Slot')); ?></span>
                        </div>
                    </div>
                    
                    <div class="space-y-2">
                        <label class="text-[10px] font-black text-gray-500 uppercase tracking-widest pl-1"><?php echo e(__('Maximum Storage')); ?> (GB)</label>
                        <div class="relative">
