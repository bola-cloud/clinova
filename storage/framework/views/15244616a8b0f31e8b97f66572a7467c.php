                    ...
                    <tr class="hover:bg-purple-50/30 transition-colors group">
                        ...
                        <td class="px-6 py-5">
                            <div class="flex items-center justify-center gap-2">
                                ...
                                <button wire:click="deleteDoctor(<?php echo e($doctor->id); ?>)" 
                                        wire:confirm="<?php echo e(__('Permanently delete this doctor and all their associated patients, visits, and staff records?')); ?>"
                                        class="p-2.5 bg-rose-100 text-rose-600 hover:bg-rose-600 hover:text-white rounded-xl transition-all" 
                                        title="<?php echo e(__('Delete Doctor Permanently')); ?>">
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        ...
                        <div class="space-y-2">
                            <label class="text-[10px] font-black text-gray-500 uppercase"><?php echo e(__('New Password (Optional)')); ?></label>
