...
<title>Clinova — <?php echo e(__('Smart Clinic Management')); ?></title>
<meta name="description" content="<?php echo e(__('The all-in-one platform for modern medical practices.')); ?>">
...
body {
  font-family: <?php echo e(app()->getLocale() === 'ar' ? "'Cairo'" : "'Outfit'"); ?>, sans-serif;
  background: #f8f9ff;
  color: #1a1a2e;
  overflow-x: hidden;
}
  ...
  <div class="container">
    <div class="nav-inner">
      <a href="/" class="nav-logo">
        <img src="<?php echo e(asset('Clinova Logo 2.png')); ?>" alt="Clinova">
      </a>
      <div class="nav-links">
        <a href="#features"><?php echo e(__('Features')); ?></a>
        <a href="#hiw"><?php echo e(__('How It Works')); ?></a>
        <a href="#testimonials"><?php echo e(__('Testimonials')); ?></a>
        <a href="#cta"><?php echo e(__('Contact')); ?></a>
      </div>
      <div class="nav-cta">
        <!-- Lang Switcher -->
        <div style="display:flex; align-items:center; gap:8px; margin-inline-end:16px; border-inline-end:1px solid #e5e7eb; padding-inline-end:16px;">
          <a href="<?php echo e(route('lang.switch', 'en')); ?>" class="<?php echo e(app()->getLocale() === 'en' ? 'gradient-text' : 'text-slate-400'); ?>" style="font-size:12px; font-weight:800; text-transform:uppercase;">En</a>
          <span style="color:#e5e7eb; font-size:12px;">/</span>
          <a href="<?php echo e(route('lang.switch', 'ar')); ?>" class="<?php echo e(app()->getLocale() === 'ar' ? 'gradient-text' : 'text-slate-400'); ?>" style="font-size:12px; font-weight:800;">عربي</a>
        </div>

        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->guard()->check()): ?>
          <a href="<?php echo e(url('/dashboard')); ?>" class="btn-primary nav-btn"><?php echo e(__('Dashboard')); ?></a>
        <?php else: ?>
...
<div x-show="mobileMenu" 
  ...
  <div class="nav-logo" style="margin-bottom:32px;">
    <img src="<?php echo e(asset('Clinova Logo 2.png')); ?>" alt="Clinova" style="height:60px;">
  </div>
  <div style="display:flex; flex-direction:column; gap:24px;">
    <a href="#features" @click="mobileMenu = false" style="font-size:20px; font-weight:700; color:#111827;"><?php echo e(__('Features')); ?></a>
    <a href="#hiw" @click="mobileMenu = false" style="font-size:20px; font-weight:700; color:#111827;"><?php echo e(__('How It Works')); ?></a>
    <a href="#testimonials" @click="mobileMenu = false" style="font-size:20px; font-weight:700; color:#111827;"><?php echo e(__('Testimonials')); ?></a>
    <a href="#cta" @click="mobileMenu = false" style="font-size:20px; font-weight:700; color:#111827;"><?php echo e(__('Contact')); ?></a>
    ...
    <div class="hero-grid">
      ...
      <div class="hero-text">
        <div class="hero-badge">
          <span class="section-badge">
            ...
            <?php echo e(__('Clinova — Smart Clinic Platform')); ?>

          </span>
        </div>
        <h1 class="hero-h1">
          <?php echo e(__('Manage Your Clinic')); ?><br>
          <span class="gradient-text"><?php echo e(__('Smarter. Faster. Better.')); ?></span>
        </h1>
        <p class="hero-desc">
          <?php echo e(__('The all-in-one platform for modern medical practices. Streamline appointments, patient records, and financial analytics with elegance and ease.')); ?>
        ...
        <div class="hero-stats">
          <div class="hero-stat">
            ...
            <div class="stat-lbl"><?php echo e(__('Doctors')); ?></div>
          </div>
          <div class="hero-stat">
            <div class="stat-val">99.9%</div>
            <div class="stat-lbl"><?php echo e(__('Uptime')); ?></div>
          </div>
        </div>
      </div>
      ...
      <div class="hero-image-wrap">
        ...
        <div class="hero-img-card">
          <img src="<?php echo e(asset('images/welcome.png')); ?>" alt="<?php echo e(__('Clinova Dashboard')); ?>">
        </div>
        <div class="float-badge float-badge-1">
          ...
          <div>
            <div class="float-badge-lbl"><?php echo e(__('Appointments Today')); ?></div>
            <div class="float-badge-val">24 <?php echo e(__('Booked')); ?></div>
          </div>
        </div>
        <div class="float-badge float-badge-2">
          ...
          <div>
            <div class="float-badge-lbl"><?php echo e(__('Monthly Revenue')); ?></div>
...
<section class="features reveal" id="features">
  <div class="container">
    <div class="section-header text-center">
      <span class="section-badge"><?php echo e(__('Core Modules')); ?></span>
      <h2 class="section-title">
        <?php echo e(__('Everything you need to run')); ?><br>
        <span class="gradient-text"><?php echo e(__('a successful practice')); ?></span>
      </h2>
      <p class="section-sub"><?php echo e(__('Designed by medical professionals for efficiency and clinical excellence.')); ?></p>
    </div>
    <div class="features-grid">
      ...
      <div class="feature-card">
        ...
        <div class="feature-name"><?php echo e(__('Smart Appointments')); ?></div>
        <div class="feature-desc"><?php echo e(__('Automated booking, queue management, and real-time availability tracking to eliminate waiting rooms.')); ?></div>
      </div>
      ...
      <div class="feature-card">
        ...
        <div class="feature-name"><?php echo e(__('Electronic Records')); ?></div>
        <div class="feature-desc"><?php echo e(__('Secure, digital patient histories with file uploads for labs and investigations. Accessible anywhere, anytime.')); ?></div>
      </div>
      ...
      <div class="feature-card">
        ...
        <div class="feature-name"><?php echo e(__('Finance Insights')); ?></div>
        <div class="feature-desc"><?php echo e(__('Comprehensive revenue dashboards, billing management, and financial growth analytics built-in.')); ?></div>
      </div>
      ...
      <div class="feature-card">
        ...
        <div class="feature-name"><?php echo e(__('Multi-Role Access')); ?></div>
        <div class="feature-desc"><?php echo e(__('Doctor, Secretary, and Admin roles — each with a tailored dashboard, permissions, and workflow.')); ?></div>
      </div>
      ...
      <div class="feature-card">
        ...
        <div class="feature-name"><?php echo e(__('Patient Profiles')); ?></div>
        <div class="feature-desc"><?php echo e(__('Complete patient history, visit records, medical files, tags, and rapid booking — all in one place.')); ?></div>
      </div>
      ...
      <div class="feature-card featured">
        ...
        <div class="feature-name"><?php echo e(__('Secure & Reliable')); ?></div>
        <div class="feature-desc"><?php echo e(__('Enterprise-grade security with encrypted data storage, role-based access, and 99.9% uptime guarantee.')); ?></div>
      </div>
    ...
    <div class="showcase-grid">
      <div class="showcase-img-wrap">
        ...
        <div class="showcase-img-card">
          <img src="<?php echo e(asset('images/doctor.png')); ?>" alt="<?php echo e(__('Feature Overview')); ?>">
        </div>
      </div>
      <div>
        <span class="section-badge"><?php echo e(__('Why Clinova?')); ?></span>
        <h2 class="section-title">
          <?php echo e(__('Your Vision,')); ?><br>
          <span class="gradient-text"><?php echo e(__('Our Platform.')); ?></span>
        </h2>
        <p class="section-sub" style="margin-bottom:8px;">
          <?php echo e(__('Clinova was built from the ground up by a team of developers working closely with real doctors. Every feature is designed to minimize admin work and maximize time with patients.')); ?>
        ...
        <div class="showcase-checks">
          ...
          ]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
          <div class="check-item">
            ...
            <div>
              <div class="check-title"><?php echo e($c[0]); ?></div>
              <div class="check-desc"><?php echo e($c[1]); ?></div>
            </div>
          </div>
...
<section class="hiw reveal" id="hiw">
  <div class="container">
    <div class="text-center">
      <span class="section-badge"><?php echo e(__('Simple Process')); ?></span>
      <h2 class="section-title">
        <?php echo e(__('How to get started')); ?><br>
        <span class="gradient-text"><?php echo e(__('with Clinova?')); ?></span>
      </h2>
    </div>
    <div class="hiw-steps" style="max-width:800px;margin-left:auto;margin-right:auto;">
      ...
      <div class="hiw-step">
        <div class="hiw-num"><?php echo e($s[0]); ?></div>
        <div class="hiw-content">
          <div class="hiw-title"><?php echo e($s[1]); ?></div>
          <div class="hiw-desc"><?php echo e($s[2]); ?></div>
        </div>
      </div>
      <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
    </div>
...
<section class="testimonials reveal" id="testimonials">
  <div class="container">
    <div class="text-center">
      <span class="section-badge"><?php echo e(__('Testimonials')); ?></span>
      <h2 class="section-title">
        <?php echo e(__('What doctors say')); ?><br>
        <span class="gradient-text"><?php echo e(__('about Clinova')); ?></span>
      </h2>
    </div>
    <div class="testimonials-grid">
      ...
      <div class="testi-card">
        ...
        <p class="testi-quote">"<?php echo e($t[3]); ?>"</p>
        <div class="testi-author">
          <div class="testi-avatar"><?php echo e($t[4]); ?></div>
          <div>
            <div class="testi-name"><?php echo e($t[0]); ?></div>
            <div class="testi-role"><?php echo e($t[1]); ?></div>
          </div>
        </div>
      </div>
      <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
    ...
    <div class="footer-grid">
      <div class="footer-brand">
        <div class="footer-logo">
          <img src="<?php echo e(asset('Clinova Logo.png')); ?>" alt="<?php echo e(__('Clinova Logo')); ?>">
        </div>
        <p class="footer-tagline"><?php echo e(__('Transforming medical practice management with modern technology.')); ?></p>
        <div class="footer-socials">
          <a href="https://www.facebook.com/share/1Gdv1x8azg/" target="_blank" class="social-btn" title="<?php echo e(__('Facebook')); ?>"><svg fill="currentColor" viewBox="0 0 24 24"><path d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878V14.89h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z"/></svg></a>
          <a href="https://www.instagram.com/clinoova?utm_source=qr&igsh=YXFjb29iaWtrM2p3" target="_blank" class="social-btn" title="<?php echo e(__('Instagram')); ?>"><svg fill="currentColor" viewBox="0 0 24 24"><path d="M12 2.163c3.204 0 3.584.012 4.85.07 3.252.148 4.771 1.691 4.919 4.919.058 1.265.069 1.645.069 4.849 0 3.205-.012 3.584-.069 4.849-.149 3.225-1.664 4.771-4.919 4.919-1.266.058-1.644.07-4.85.07-3.204 0-3.584-.012-4.849-.07-3.26-.149-4.771-1.699-4.919-4.92-.058-1.265-.07-1.644-.07-4.849 0-3.204.013-3.583.07-4.849.149-3.227 1.664-4.771 4.919-4.919 1.266-.057 1.645-.069 4.849-.069zM12 0C8.741 0 8.333.014 7.053.072 2.695.272.273 2.69.073 7.052.014 8.333 0 8.741 0 12c0 3.259.014 3.668.072 4.948.2 4.358 2.618 6.78 6.98 6.98 1.281.058 1.689.072 4.948.072 3.259 0 3.668-.014 4.948-.072 4.354-.2 6.782-2.618 6.979-6.98.059-1.28.073-1.689.073-4.948 0-3.259-.014-3.668-.072-4.948-.2-4.353-2.612-6.78-6.979-6.98C15.668.014 15.259 0 12 0zm0 5.838a6.162 6.162 0 100 12.324 6.162 6.162 0 000-12.324zM12 16a4 4 0 110-8 4 4 0 010 8zm6.406-11.845a1.44 1.44 0 100 2.881 1.44 1.44 0 000-2.881z"/></svg></a>
          <a href="mailto:clinova252@gmail.com" class="social-btn" title="<?php echo e(__('Email Us')); ?>"><svg fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"/></svg></a>
        </div>
      </div>
      <div class="footer-col">
        ...
        <ul>
          ...
          <li><a href="#hiw"><?php echo e(__('How It Works')); ?></a></li>
          <li><a href="<?php echo e(route('login')); ?>"><?php echo e(__('Log in')); ?></a></li>
      ...
      <div class="footer-col">
        ...
        <ul>
          ...
          <li><a href="#cta"><?php echo e(__('Contact')); ?></a></li>
        </ul>
      </div>
      <div class="footer-col">
        <h5><?php echo e(__('Legal')); ?></h5>
        <ul>
          <li><a href="#"><?php echo e(__('Privacy')); ?></a></li>
          <li><a href="#"><?php echo e(__('Terms')); ?></a></li>
        </ul>
      </div>
    </div>
    <div class="footer-bottom">
      <span>© <?php echo e(date('Y')); ?> Clinova. <?php echo e(__('All rights reserved.')); ?></span>
      <div class="status-dot">
        <div class="dot-green"></div>
        <span style="color:#10b981;font-weight:600;"><?php echo e(__('All systems operational')); ?></span>
      </div>
    </div>
  </div>
</footer>
...
<div class="floating-container float-left" x-data="{ open: false }">
    <div class="social-menu" :class="open ? 'social-menu-open' : ''" x-show="open" x-transition:enter="transition ease-out duration-300" x-transition:enter-start="opacity-0 translate-y-10" x-transition:enter-end="opacity-100 translate-y-0" x-cloak>
        <a href="https://www.facebook.com/share/1Gdv1x8azg/" target="_blank" class="social-item" style="transition-delay: 0.1s" title="<?php echo e(__('Facebook')); ?>">
        ...
        <a href="https://www.instagram.com/clinoova?utm_source=qr&igsh=YXFjb29iaWtrM2p3" target="_blank" class="social-item" style="transition-delay: 0.2s" title="<?php echo e(__('Instagram')); ?>">
        ...
        <a href="mailto:clinova252@gmail.com" class="social-item" style="transition-delay: 0.3s" title="<?php echo e(__('Email Us')); ?>">
            <svg style="width:24px;height:24px;fill:none;stroke:currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"/>
            </svg>
        </a>
    </div>
    <button @click="open = !open" class="float-btn social-trigger" :style="open ? 'transform: rotate(45deg)' : ''" title="<?php echo e(__('Social Media')); ?>">
...
<?php /**PATH C:\Bola\Clinova\resources\views/welcome.blade.php ENDPATH**/ ?>