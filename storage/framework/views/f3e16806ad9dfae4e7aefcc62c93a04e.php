...
@media (max-width: 640px) {
  ...
  .hero-stat:nth-child(3) { grid-column: span 2; border-top: 1px solid rgba(124,58,237,0.05) !important; }
    ...
    <div class="hero-grid">
      ...
      <div class="hero-text">
        ...
        <div class="hero-stats">
          ...
          <div class="hero-stat">
            ...
            <div class="stat-lbl"><?php echo e(__('Patients')); ?></div>
          </div>
          <div class="hero-stat">
      ...
      <div class="hero-image-wrap">
        ...
        <div class="hero-img-card">
          <img src="<?php echo e(asset('images/hero.png')); ?>" alt="<?php echo e(__('Clinova Dashboard')); ?>">
        </div>
...
<div class="trust-bar">
  <div class="container">
    <div class="trust-label"><?php echo e(__('Trusted by leading clinics and medical centers')); ?></div>
    <div class="trust-logos">
      <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = [['🏥', __('General Clinic')], ['🦷', __('Dental Center')], ['👁️', __('Eye Clinic')], ['🫀', __('Heart Center')], ['🧠', __('Neurology')], ['🦴', __('Orthopedics')]]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $logo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
      <div class="trust-logo">
        <span><?php echo e($logo[0]); ?></span>
        <span><?php echo e($logo[1]); ?></span>
      </div>
    ...
    <div class="showcase-grid">
      <div class="showcase-img-wrap">
        ...
        <div class="showcase-img-card">
          <img src="<?php echo e(asset('images/features.png')); ?>" alt="<?php echo e(__('Feature Overview')); ?>">
        </div>
      </div>
      <div>
    ...
    <div class="footer-grid">
      <div class="footer-brand">
        <div class="footer-logo">
          <img src="<?php echo e(asset('Clinova Logo.png')); ?>" alt="Clinova">
        </div>
