...
<?php $component = App\View\Components\ClinicLayout::resolve(['title' => 'لوحة السكرتارية'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
[$__name, $__params] = $__split('dashboard.secretary-dashboard', []);

$__key = null;

$__key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-1582514551-0', $__key);
...
<?php endif; ?>
<?php /**PATH C:\Bola\Clinova\resources\views/dashboard/secretary.blade.php ENDPATH**/ ?>