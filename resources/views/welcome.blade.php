      ...
      <div class="nav-cta">
        ...
        @else
          ...
          @if(Route::has('register'))
            <a href="https://wa.me/201021075791" target="_blank" class="btn-primary nav-btn">{{ __('Start Free Trial') }}</a>
          @endif
        @endauth
...
<div x-show="mobileMenu" 
  ...
  <div style="display:flex; flex-direction:column; gap:24px;">
    ...
    @else
      ...
      <a href="https://wa.me/201021075791" target="_blank" class="btn-primary" style="padding:16px; margin-top:10px;">{{ __('Start Free Trial') }}</a>
    @endauth
  </div>
</div>
  ...
  <div class="container">
    <div class="hero-grid">
      ...
      <div class="hero-text">
        ...
        <div class="hero-btns">
          <a href="https://wa.me/201021075791" target="_blank" class="btn-primary hero-btn-main" style="padding:16px 40px;font-size:16px;">
            {{ __('Start Free Trial') }}
          </a>
  ...
  <div class="container">
    <div class="cta-card">
      ...
      <div style="position:relative;z-index:1;">
        ...
        <div class="cta-btns">
          <a href="https://wa.me/201021075791" target="_blank" class="cta-btn-white">{{ __('Start Free Trial') }}</a>
...
<div class="floating-container float-right">
    <a href="https://wa.me/201021075791" target="_blank" class="float-btn whatsapp-btn" title="{{ __('Contact us on WhatsApp') }}">
